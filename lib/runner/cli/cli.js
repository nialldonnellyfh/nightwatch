...
module.exports = new (function() {
  ...
  this.setup = function() {
    ...
    // $ nightwatch -ff
    // $ nightwatch --failedTests
    this.command('failedTests')
      .description('List Of Failed Tests To Run Again.')
      .alias('ff');
    ...
    // $ nightwatch -st
    // $ nightwatch --skiptag
    this.command('skiptag')
      .description('Skip Tests Containing A Tag.')
      .defaults('')
      .alias('st');
